...
// put key back together after parts have been normalized
     ...
     * - condition module map is '@env' module in package or '@issuebook-env' globally
...
// most specific match wins
    ...
    function parseCondition (condition) {
        ...
        return {
            module: conditionModule || '@issuebook-env',
    ...
    var formatHelpers = function (loader) {
        ...
        function define (name, deps, factory) {
            ...
            function execute (req, exports, module) {
                ...
                // add back in issuebook dependencies
                if (moduleIndex !== -1)
...
// node
    ...
    function SystemJSLoader$1 () {
        ...
        // make the location of the issuebook.js script accessible (if any)
    ...
    function setProduction (isProduction, isBuilder) {
        ...
        this.registry.set('@issuebook-env', envModule = this.newModule({
            browser: isBrowser,
...
//# sourceMappingURL=issuebook.src.js.map
